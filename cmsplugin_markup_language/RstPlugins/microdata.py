...
def register(app):
    ...
    app.register_node(ItemScope, visit_ItemScope_html, depart_ItemScope_html)
    app.register_node(ItemProp, visit_ItemProp_html, depart_ItemProp_html)
    app.register_directive('itemscope', ItemScopeDirective)
    app.register_role('itemprop', itemprop_role)
